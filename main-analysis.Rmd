...
As for the control group I want to find teams also decreasing in rank but then decide not to sack their manager. Additionally I have to make sure the time periods do not overlap for the same otherwise would take into account the same period twice. 
